...
export default function English() {
  return (
    <div>
      ...
      I currently work as a <strong>Developer Specialist</strong> at <a href="https://www.grupoboticario.com.br/en/home-en/" target="_blank" className="text-green-500">Grupo Boticário</a>.
      </p>
